...
public class Project {
	...
	private java.util.List<String> sprints;
	 ...
	 */
	public Project(String nombre, java.time.LocalDate FechaDeInicio, java.time.LocalDate FechaDeTerminado, java.util.List<Tarea> tareas, String presupuesto, String ManagerDeProyecto) {
	...
	public java.util.Date getFechaDeTerminado() {
	...
	public java.util.List<String> getSprintsFases() {
